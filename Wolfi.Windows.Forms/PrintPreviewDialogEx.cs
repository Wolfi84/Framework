...
{
    /// <summary>
    /// Erweitert den Standard Windows PrintPreviewDialog um
    /// die Möglichkeit die Position und Fenstergröße 
    /// zu speichern und wiederherzustellen.
    /// </summary>
    public partial class PrintPreviewDialogEx : System.Windows.Forms.PrintPreviewDialog, Wolfi.Core.Kontext.IAppKontext
    {
        /// <summary>
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!this.DesignMode)
            {
                ...
                if (AltePosition != null)
                {
                    ...
                    //Nur Maximiert wiederherstellen, Minimiert wird Normal aufgebaut...
                    this.WindowState
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            ...
            //Nur wenn die Anwendung läuft, nicht im Designer,
            //weil dieser mit einer Null-Referenz Ausnahme abstürzt
            if (!this.DesignMode)
            {
