...
namespace Wolfi.Core.WPF.NetCore.Anwendung.ViewModels.Hauptfenster
{
    /// <summary>
    /// Stellt den Dienst zum verwalten des HauptFensters 
    /// zur Verfügung
    /// </summary>
    public class HauptfensterViewModel : Wolfi.Core.Kontext.Anwendungsobjekt
    {
        /// <summary>
        ...
        protected virtual void InitialisiereFenster(System.Windows.Window fenster)
        {
            ...
            fenster.Closing += (sender, e) =>
            {
                ...
                var Position = new Wolfi.Core.Fenster.Fenster { Name = fenster.Name };
        ...
        /// </summary>
        public Wolfi.Core.Sprachen.Sprache AktuelleSprache
        {
            get
            {
            ...
            set
            {
                ...
                if (this.AppKontext.Sprachen.AktuelleSprache.Code != value.Code)
                {
                    ...
                    this.AppKontext.Protokoll.Eintragen(
                        Properties.Texte.Sprachwechsel,
                        Wolfi.Core.Protokoll.ProtokollEintragTyp.Fehler);
                }
        ...
        public Models.DTOs.Aufgaben Aufgaben
        {
            get
            {
                if (this._Aufgaben == null)
                {
                    ...
                    var i = Wolfi.Core.WPF.NetCore.Anwendung.Properties.Settings.Default.AktuelleAufgabe;
