...
namespace Wolfi.Core.Fenster
{
    ...
    public class FensterManager : Core.Kontext.Anwendungsobjekt
    {
        /// <summary>
        ...
        /// </summary>
        private Core.Fenster.FensterXmlController _Controller = null;

        /// <summary>
        /// Ruft den Dienst zum Schreiben und Lesen
        /// der Fensterdaten aus einer Xml Datei ab.
        /// </summary>
        private Core.Fenster.FensterXmlController Controller
        {
            get
            {
                ...
                {
                    this._Controller
                        = this.AppKontext.Erzeuge<Core.Fenster.FensterXmlController>();
                }
        ...
        /// </summary>
        private Core.Fenster.FensterListe _Liste = null;
        ...
        protected Core.Fenster.FensterListe Liste
        {
            get
            {
                if (this._Liste == null)
                {
                    ...
                    catch (System.Exception ex)
                    {
                        ...
                        this.OnFehlerAufgetreten(new Core.Kontext.FehlerAufgetretenEventArgs(ex));
                        this._Liste = new Core.Fenster.FensterListe();
                    }
                }
        ...
        public void Hinterlegen(Core.Fenster.Fenster fenster)
        {
        ...
        public Core.Fenster.Fenster Abrufen(string fensterName)
        {
